...
/// </summary>
[DataContract]
public sealed record TaskEndedEvent
{
    ...
    /// </summary>
    [DataMember(Name = "status", Order = 3), JsonPropertyName("status"), JsonPropertyOrder(3)]
    public required string Status { get; set; }

    /// <summary>
    /// Gets/sets the date and time at which the task has ended
    /// </summary>
    [DataMember(Name = "endedAt", Order = 4), JsonPropertyName("endedAt"), JsonPropertyOrder(4)]
