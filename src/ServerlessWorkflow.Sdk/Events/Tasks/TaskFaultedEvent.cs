...
/// </summary>
[DataContract]
public sealed record TaskFaultedEvent
{
    ...
    /// </summary>
    [DataMember(Name = "error", Order = 3), JsonPropertyName("error"), JsonPropertyOrder(3)]
    public required Error Error { get; set; }

    /// <summary>
    /// Gets/sets the date and time at which the task has faulted
    /// </summary>
    [DataMember(Name = "faultedAt", Order = 4), JsonPropertyName("faultedAt"), JsonPropertyOrder(4)]
