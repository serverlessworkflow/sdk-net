...
/// <summary>
/// Represents the data carried by the cloud event that notifies that a task has started
/// </summary>
[DataContract]
public sealed record TaskStartedEvent
{
    ...
    /// <summary>
    /// Gets/sets the qualified name of the workflow instance the task that has started belongs to
    /// </summary>
    [DataMember(Name = "workflow", Order = 1), JsonPropertyName("workflow"), JsonPropertyOrder(1)]
    public required string Workflow { get; set; }

    /// <summary>
    /// Gets/sets the reference of the task that has started
    /// </summary>
    ...
    /// </summary>
    [DataMember(Name = "startedAt", Order = 3), JsonPropertyName("startedAt"), JsonPropertyOrder(3)]
