...
/// </summary>
[DataContract]
public sealed record WorkflowCorrelationCompletedEvent
{
    ...
    /// </summary>
    [DataMember(Name = "correlationContext", Order = 2), JsonPropertyName("correlationContext"), JsonPropertyOrder(2)]
    public required string CorrelationContext { get; set; }

    /// <summary>
    /// Gets a key/value mapping of the context's correlation keys
    /// </summary>
    [DataMember(Name = "correlationKeys", Order = 3), JsonPropertyName("correlationKeys"), JsonPropertyOrder(3)]
    ...
    /// </summary>
    [DataMember(Name = "completedAt", Order = 4), JsonPropertyName("completedAt"), JsonPropertyOrder(4)]
