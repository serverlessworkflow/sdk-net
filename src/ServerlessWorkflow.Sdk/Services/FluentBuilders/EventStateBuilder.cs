...
namespace ServerlessWorkflow.Sdk.Services.FluentBuilders
{
        ...
        : StateBuilder<EventStateDefinition>, IEventStateBuilder
    {
        ...
        public EventStateBuilder(IPipelineBuilder pipeline)
            : base(pipeline)
        {
        ...
        public virtual IEventStateBuilder Trigger(Action<IEventStateTriggerBuilder> triggerSetup)
        {
            if (triggerSetup == null)
                throw new ArgumentNullException(nameof(triggerSetup));
            IEventStateTriggerBuilder builder = new EventStateTriggerBuilder(this.Pipeline);
            triggerSetup(builder);
            this.State.Triggers.Add(builder.Build());
            return this;
        }
