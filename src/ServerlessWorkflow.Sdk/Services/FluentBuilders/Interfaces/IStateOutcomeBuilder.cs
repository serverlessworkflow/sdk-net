...
namespace ServerlessWorkflow.Sdk.Services.FluentBuilders
{
    ...
    public interface IStateOutcomeBuilder
    {
        ...
        /// </summary>
        /// <param name="stateSetup">An <see cref="Func{T, TResult}"/> used to setup the <see cref="StateDefinition"/> to transition to</param>
        ...
        /// <summary>
        /// Configure the <see cref="StateDefinition"/> to end the workflow
        /// </summary>
