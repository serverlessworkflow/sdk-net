...
/// <summary>
/// Represents the <see cref="IValidator"/> used to validate <see cref="TaskDefinition"/> key/value pairs
/// </summary>
public class TaskKeyValuePairValidator
    : AbstractValidator<KeyValuePair<string, TaskDefinition>>
{

    /// <inheritdoc/>
    public TaskKeyValuePairValidator(IServiceProvider serviceProvider, ComponentDefinitionCollection? components, IDictionary<string, TaskDefinition>? tasks)
    {
