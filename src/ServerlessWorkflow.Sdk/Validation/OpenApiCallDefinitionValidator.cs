...
/// <summary>
/// Represents the <see cref="IValidator"/> used to validate <see cref="OpenApiCallDefinition"/>s
/// </summary>
public class OpenApiCallDefinitionValidator
    : AbstractValidator<OpenApiCallDefinition>
{

    /// <inheritdoc/>
    public OpenApiCallDefinitionValidator(IServiceProvider serviceProvider, ComponentDefinitionCollection? components)
    {
