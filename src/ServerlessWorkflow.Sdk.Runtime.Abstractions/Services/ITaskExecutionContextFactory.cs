...
public interface ITaskExecutionContextFactory
{
    ...
    /// <summary>
    /// Creates a new <see cref="ITaskExecutionContext"/> implementation for the <see cref="ITaskState"/>
    /// </summary>
    /// <param name="workflow">The <see cref="IWorkflowExecutionContext"/> the <see cref="ITaskExecutionContext"/> belongs to</param>
    /// <param name="definition">The <see cref="TaskDefinition"/> of the <see cref="ITaskState"/> to run</param>
    /// <param name="state">The <see cref="ITaskState"/> to run</param>
    ...
    ITaskExecutionContext Create(IWorkflowExecutionContext workflow, TaskDefinition definition, ITaskState state, JsonObject? arguments = null);
