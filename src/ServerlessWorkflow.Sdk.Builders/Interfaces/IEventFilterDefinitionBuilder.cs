...
/// <summary>
/// Defines the fundamentals of a service used to build <see cref="EventFilterDefinition"/>s
/// </summary>
public interface IEventFilterDefinitionBuilder
{
    ...
    /// </summary>
    /// <returns>A new <see cref="EventFilterDefinition"/></returns>
    EventFilterDefinition Build();
