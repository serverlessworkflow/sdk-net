...
/// </summary>
public interface ErrorDefinitionBuilder
{
    ...
    /// <returns>The configures <see cref="ErrorDefinitionBuilder"/></returns>
    ErrorDefinitionBuilder WithType(string type);
    ...
    /// <returns>The configures <see cref="ErrorDefinitionBuilder"/></returns>
    ErrorDefinitionBuilder WithStatus(string status);
    ...
    /// <returns>The configures <see cref="ErrorDefinitionBuilder"/></returns>
    ErrorDefinitionBuilder WithTitle(string title);
    ...
    /// <returns>The configures <see cref="ErrorDefinitionBuilder"/></returns>
    ErrorDefinitionBuilder WithDetail(string detail);
    ...
    /// <returns>The configures <see cref="ErrorDefinitionBuilder"/></returns>
    ErrorDefinitionBuilder WithInstance(string instance);
