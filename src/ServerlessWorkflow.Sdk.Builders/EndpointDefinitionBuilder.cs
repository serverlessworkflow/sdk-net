    ...
    : IEndpointDefinitionBuilder
{
    ...
    public virtual EndpointDefinition Build()
    {
        ...
        if (AuthenticationReference == null) endpoint.Authentication = new() { Ref = AuthenticationReference };
        else if (Authentication != null) endpoint.Authentication = Authentication;
        return endpoint;
    }
