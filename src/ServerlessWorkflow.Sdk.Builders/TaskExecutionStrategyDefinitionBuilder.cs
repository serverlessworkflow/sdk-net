...
/// <summary>
/// Represents the default implementation of the <see cref="ITaskExecutionStrategyDefinitionBuilder"/> interface
/// </summary>
public class TaskExecutionStrategyDefinitionBuilder
    : ITaskExecutionStrategyDefinitionBuilder
{
    ...
    /// <inheritdoc/>
    public virtual ITaskExecutionStrategyDefinitionBuilder Sequentially(Action<ITaskDefinitionMappingBuilder> setup)
    {
    ...
    /// <inheritdoc/>
    public virtual ITaskExecutionStrategyDefinitionBuilder Concurrently(Action<ITaskDefinitionMappingBuilder> setup)
    {
        var builder = new TaskDefinitionMappingBuilder();
        setup(builder);
    ...
    /// <inheritdoc/>
    public virtual ITaskExecutionStrategyDefinitionBuilder Compete()
    {
    ...
    /// <inheritdoc/>
    public virtual TaskExecutionStrategyDefinition Build()
    {
