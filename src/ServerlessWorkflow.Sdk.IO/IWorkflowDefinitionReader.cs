...
public interface IWorkflowDefinitionReader
{
    ...
    /// <param name="options">The <see cref="WorkflowDefinitionReaderOptions"/> to use</param>
    /// <param name="cancellationToken">A <see cref="CancellationToken"/></param>
    /// <returns>A new <see cref="WorkflowDefinition"/></returns>
    Task<WorkflowDefinition> ReadAsync(Stream stream, WorkflowDefinitionReaderOptions? options = null, CancellationToken cancellationToken = default);
