    ...
    : TaskExecutorTestsBase
{
    ...
    public async Task Execute_Should_Create_Branch_Tasks_For_All_Branches()
    {
        ...
        Mock.Get(taskContext.Object.Instance)
            ...
            .Returns(() =>
            {
                var completedState = new Mock<ITaskState> { CallBase = true };
                completedState.Setup(s => s.Status).Returns(TaskInstanceStatus.Completed);
    ...
    {
        var childState = new Mock<ITaskState> { CallBase = true };
